...
<head>
    <meta charset="UTF-8">
    <title>Educator Session Expired</title>
    <style>
...
<body>
    <div class="container">
        <div class="message">
            <h2>Error Creating Course</h2>
            <h3>Error : <c:out value="${message}"></c:out></h3>
        </div>
        <a href="addcourse" class="try-again">Please Try Again</a>
    </div>
</body>
</html>
